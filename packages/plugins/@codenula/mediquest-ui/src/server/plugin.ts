...
import { create } from 'packages/core/actions/src/actions';
...
// async function createTestCity(mycity) {
//   try {
//     const testStateURL = 'https://mediquest.codenula.com/api/test_cities:create';
...
//         Authorization: COLLECTION_AUTH_TOKEN,
//       },
//       body: JSON.stringify({ city_name: mycity.city_name, stateId: parseInt(mycity.stateId) }),
//     });
//   } catch (err) {
//     console.log(err);
//   }
// }
// async function createTestState(mystate) {
//   try {
...
//         Authorization: COLLECTION_AUTH_TOKEN,
//       },
//       body: JSON.stringify({ state_name: mystate.state_name, countryId: parseInt(mystate.countryId) }),
//     });
//   } catch (err) {
//     console.log(err);
//   }
...
export class MediquestUiServer extends Plugin {
  afterAdd() {}

  beforeLoad() {}
  // Visit: http://localhost:15000/api/razorPay:createOrder
  // Visit: http://localhost:15000/api/razorPay:getOrder
  // Visit: http://localhost:15000/api/razorPay:test
  // Visit: http://localhost:15000/api/razorPay:paymentFailed
  // Visit: http://localhost:15000/api/razorPay:verifyPayment
  async load() {
    this.app.resource({
      name: 'razorPay',
      actions: {
    ...
    //   name: 'create',
    //   actions: {
    //     async createAllStates(ctx, next) {
    //       allStates.forEach(async (state) => {
    //         await createTestState(state);
    //       });

    //       ctx.body = 'states created';
    //     },
    //     async createAllCities(ctx, next) {
    //       allCities.forEach(async (city) => {
    //         await createTestCity(city);
    //       });

    //       ctx.body = 'cities created';
    //     },
...
export default MediquestUiServer;
